...
function BallSummary({ summary }: { summary: EventType }) {
  ...
  if (summary === '-3') return <li className={summaryVariants({ variant: '-3' })}>NB</li>
  else if (summary === '-2') return <li className={summaryVariants({ variant: '-2' })}>Wd</li>
  else if (summary === '-1') return <li className={summaryVariants({ variant: '-1' })}>W</li>
  else
    return (
      <li
