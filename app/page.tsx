...
//             and fun. Share your scores and relive the excitement with friends
//             and teammates.
//           </p>
//         </div>
...
//             players, teams, and matches, and keep track of the score ball by
//             ball. Whether you&apos;re playing a friendly match or an intense
//             tournament, BallByBall ensures that every moment is recorded
//             accurately and conveniently. Share the scorecard with your friends
//             and teammates, and relive the excitement of every match with ease.
//           </p>
//           <p className="mb-4">
//             With BallByBall, you don&apos;t need to worry about complex setups
//             or hidden fees. Our service is completely free, providing you with
//             all the tools you need to manage your cricket scoring efficiently.
//             Simply sign in and start scoring – it&apos;s that simple! The
//             intuitive interface and comprehensive features make BallByBall the
//             perfect choice for both amateur cricketers and seasoned
//             professionals. Cheers to making every match memorable with
//             BallByBall!
//           </p>
//           <p>
...
//             templates, and live scoring options. Whether you prefer using our
//             app, software, or online tools, BallByBall is here to support your
//             cricket journey. Join us today and see why we&apos;re the preferred
...
function HomePage() {
  return <div>Cricket Scoring Made Easy</div>;
}
